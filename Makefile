...
build:
	go build -ldflags="-X 'github.com/andrewmarklloyd/pi-sensor/cmd.version=$(GIT_TREE_STATE)'" -o build/pi-sensor-server main.go
	GOOS=linux GOARCH=arm GOARM=5 go build -o build/pi-sensor-agent agent-v1/*.go
